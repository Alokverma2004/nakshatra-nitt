    ...
    <>
      ...
      <section className="relative min-h-[100vh] flex items-center justify-center text-center px-4 parallax-container">
        ...
        <div className="container mx-auto relative z-10 py-16 md:py-0">
          ...
          <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-poppins mb-6 leading-tight transition-all duration-1000 ease-out text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-100 to-blue-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Nakshatra
          </h1>
      ...
      <section className="section bg-space-dark" ref={featuredElementsRef}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Team Feature */}
            <div className="space-card p-6 hover:border-space-blue transition-colors group reveal sm:col-span-2 lg:col-span-1">
              <div className="flex items-center mb-4">
                <div className="bg-space-blue/20 p-3 rounded-lg mr-4">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full lg:w-2/3 space-y-6 reveal">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-poppins mb-4 text-center lg:text-left">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-100 to-blue-300">VYOMIKA: Astronomy Magazine</span>
              </h2>
              ...
              <div className="flex flex-wrap gap-4 pt-4 justify-center lg:justify-start">
                ...
                <a 
                  href="#" 
                  className="btn-outline flex items-center gap-2 text-base sm:text-lg"
                >
      ...
      <section className="py-16 sm:py-20 bg-space-dark relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-poppins mb-6 text-white reveal">
            Join Us in Exploring the Cosmos
          </h2>
          <div className="flex flex-wrap justify-center gap-4 reveal mt-6">
            <Link to="/contact" className="btn-primary text-base sm:text-lg font-medium glow-on-hover">
              Contact Us
            </Link>
            <Link to="/events" className="btn-outline text-base sm:text-lg font-medium glow-on-hover">
              Join an Event
            </Link>
          </div>
        </div>
